...
function insertTodoAndStudyGeneral($conn, $uid, $category_id, $todoTitle, $todoIntroduction, $todoLabel, $startDateTime,$sportType, $sportValue, $sportUnit ,$frequency, $reminderTime, $dueDateTime, $todoNote) {
...
if ($result->num_rows == 0) {
    if ($frequency == 0) {
        ...
        $result1 = insertTodoAndStudyGeneral($conn, $uid, $category_id, $todoTitle, $todoIntroduction, $todoLabel, $startDateTime, $sportType, $sportValue, $sportUnit, $frequency, $reminderTime, $dueDateTime, $todoNote);
